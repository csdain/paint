...
public class SmokeTest {
    ...
    private static String protocol = "pbdb";
...
//            statement.execute("DROP DATABASE SaMpLe;");
  ...
  public void testSelect() throws SQLException {
      ...
      try {
          ...
          ResultSet result = (ResultSet) statement.executeQuery("SELECT * From table_name12");
          int rows = 0;
          while (result.next())
              rows++;
  ...
  public void testConditionalSelect() throws SQLException {
      ...
      try {
          ...
          Assert.assertNotEquals("Insert returned zero rows", 0, count4);
          ResultSet result = (ResultSet) statement.executeQuery("SELECT column_name1 FROM table_name13 WHERE coluMN_NAME2 < 5");
          int rows = 0;
          while (result.next())
              rows++;
          Assert.assertNotNull("Null result retruned", result);
  ...
  public void testExecute() throws SQLException {
      ...
      try {
          ...
          boolean result4 = statement.execute("SELECT column_name1 FROM table_name13 WHERE coluMN_NAME2 > 100 union "
          		+ "nothing");
          Assert.assertFalse("Wrong return for select non existing records", result4);
          statement.close();
      } catch (Throwable e) {
          TestRunner.fail("Failed to select from table", e);
      }
  ...
  public void testDistinct() throws SQLException {
      ...
      try {
          ...
          Assert.assertTrue("Wrong return for select existing records", result2);
          ResultSet res1 = (ResultSet) statement.getResultSet();
          ...
          ResultSet res2 = (ResultSet) statement.getResultSet();
  ...
  public void testAlterTable() throws SQLException {
      ...
      try {
          ...
          boolean result3 = statement.execute("SELECT column_name4 FROM table_name13 WHERE coluMN_NAME2 = 5 order by column_name4");
          Assert.assertTrue("Wrong return for select existing records", result3);
          ResultSet res2 = (ResultSet) statement.getResultSet();
          int rows2 = 0;
          while (res2.next())
          ...
          int count5 = statement.executeUpdate(
                  "INSERT INTO table_name13(column_name1, COLUMN_NAME3, column_NAME2, column_name4) VALUES ('value5', 'value6', 6, '2011-01-25')");
          Assert.assertNotEquals("Insert returned zero rows", 0, count5);
          
          boolean result4 = statement.execute("SELECT column_name4 FROM table_name13 WHERE coluMN_NAME2 > 4 order by column_name4");
          Assert.assertTrue("Wrong return for select existing records", result4);
          ResultSet res3 = (ResultSet) statement.getResultSet();
          
          int rows3 = 0;
          while (res3.next())
              rows3++;

          Assert.assertEquals("Wrong number of rows", 3, rows3);
          Assert.assertEquals("2011-01-25", res3.getDate("column_name4").toString());

          while (res3.previous())
              ;
          res3.next();
          Assert.assertNull("Retrieved date is not null", res3.getDate("column_name4"));
